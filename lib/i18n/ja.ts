export const ja = {
  ...
  hero: {
    ...
    greeting:
      "皆様にはますますご清祥のこととお慶び申し上げます さて私たちはこのたび令和6年11月2日に入籍し新たな生活を始めることとなりました 日頃よりお世話になっております皆様に感謝を込めご報告を兼ねてささやかではございますが披露の宴を催したいと存じます ご多用の折誠に恐縮に存じますがぜひご臨席賜りますようお願い申し上げます",
  },
  cta: {
    rsvp: "出欠登録",
  },
  ...
  dresscode: {
    title: "ドレスコード",
    subtitle: "華やかな色彩で彩られた結婚式を心に描いております ぜひ 色とりどりのお召し物でお越しいただき 会場をさらに鮮やかに彩っていただけると幸いです",
    point: {
      ok: "推奨スタイルのポイント",
      ng: "NGスタイルのポイント"
    },
  ...
  gallery: {
    ...
    images: [
      ...
      "2回目?のデート in 淡路島",
      "初めてのツーショット",
      "ドラクエウォークのイベントのために富士急へ",
      "ドラクエウォークのイベントのために奈良へ (Part1)",
      "ドラクエウォークのイベントのために奈良へ (Part2)",
      "お花見🌸",
      "白黒やとテカっちゃう",
    ],
    lightbox: {
  ...
  footer: {
    title: "皆様にお会いできるのを心待ちにしています",
    message: "ご予定の変更により出欠が変わる場合は お手数ですが直接ご連絡ください",
